...
class _JapanPageState extends State<JapanPage> {
  ...
  final Map<String, List<String>> prefectureImages = { //画像の名前の部分の整数を都道府県ごとに取得している
    "長崎県": ["000"],
    "佐賀県": ["000", "001"],
    "鹿児島県": ["000","001"],
    "熊本県": ["000","001","002"],
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: PageView.builder(
        ...
        itemCount: prefectures.length, //都道府県の数分表示
        itemBuilder: (context, index) { //indexで都道府県のインデックス(今いる位置)を取得している
          return Card(
